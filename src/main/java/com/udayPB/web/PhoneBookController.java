...
import com.udayPB.exceptions.PhoneBookException;
import com.udayPB.model.PhoneBookUser;
import com.udayPB.service.ContactService;

/**
 * Serves Uday Phonebook operations
 * 
 * @author Uday
 *
 */
...
public class PhoneBookController {
	...
	@Value("${application.message:Welcome to Uday !!}")
